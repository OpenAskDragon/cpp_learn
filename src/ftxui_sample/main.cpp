...
// configuration step. It creates a namespace called `cpp_learn`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_learn::cmake::project_name, cpp_learn::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_learn::cmake::project_version);
      return EXIT_SUCCESS;
    }
